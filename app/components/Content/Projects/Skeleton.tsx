	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-6 px-6">
				...
				<div
					className="bg-borders h-6 w-48 animate-pulse rounded-md"
					aria-hidden="true"
				/>
				<div
					className="bg-borders h-6 w-32 animate-pulse rounded-md"
					aria-hidden="true"
				/>
				<div
					className="bg-borders h-14 w-full animate-pulse rounded"
					aria-hidden="true"
				/>
				<div className="flex flex-wrap gap-2" aria-hidden="true">
					{[...Array(3)].map((_, i) => (
						<div
							key={i}
							className="bg-borders h-6 w-20 animate-pulse rounded-md"
						/>
					))}
				</div>
				<div
				...
				>
					{[...Array(3)].map((_, i) => (
						<div
							key={i}
							className="bg-borders h-5 w-3/4 animate-pulse rounded"
						/>
					))}
				</div>
				<div
			...
			>
				{[...Array(2)].map((_, i) => (
					<div
						key={i}
						className="bg-borders h-10 w-28 animate-pulse rounded-2xl"
					/>
				))}
			</div>
		</article>
