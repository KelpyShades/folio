export const Profile = {
	...
	INTRO: `y/o self-taught full-stack software developer`,
	ATTR_1: "@404-Not-Null",
	ATTR_2: "@Class-io",
	LINK_1: "https://404notnull.vercel.app",
	LINK_2: "https://class-io.vercel.app",
	TECHSTACK: ["Flutter", "Next.js", "Typescript", "PostgreSQL", "Tailwind CSS"],
	SOCIALS: [
		{
			id: 1,
		...
		{
			id: 4,
			href: "https://discord.com/users/767010609975263294",
			src: "discord",
		},
		{
			id: 5,
...
export const Content = {
	About: {
		...
		resume:
			"https://drive.google.com/file/d/1qJyJ8I59LNaqwSYdrz_8yRbi2YYAQr2W/view?usp=drive_link",
	},
	Experience: {
		title: "My Experience",
		experience: [
			{
				...
				desc: "I teamed up with friends to launch a startup, Class-io, that eventually led us to settling as a group of indie devs calling ourselves 404-Not-Null focused on creating solutions for real-world issues. Our first project, Class-io, tackles the hassle of paper-based attendance by digitizing it into an efficient system and we have more projects in the pipeline. As a founder, I’ve stepped up to lead and manage the team, gaining skills in communication, cooperation, and project management and I’m excited to grow this into something big and impactful.",
			},
			{
				title:
					"> Full Stack Developer, Heidielberg Materials Hackathon UENR (2025)",
				desc: "I joined a 4-days hackathon where every team was instructed to make a simeple online store and that implements a secure payment gateway. Although my team came up 3rd, It was a great chance to experience how working in teams under pressure feels, the tension and the pressure to deliver a working product within the given time frame.",
			},
			{
				title:
					"> Frontend Developer Intern, Guru Coding Academy (October - December 2023)",
			...
			{
				title:
					"> Volunteer, D & H Heavy Duty Mechanics Company Limited (October - December 2022)",
	...
	Education: {
		...
		education: [
			{
				title: "> University of Energy and Natural Resources (2021-Current)",
				desc: "I am currently studying Bsc Computer Science at the University of Energy and Natural Resources. I am expected to graduate in 2026. Participated in a whole lot of projects whether been academic ones, personal ones or even team project like the Heidielberg Materials Hackathon UENR 2025.",
			},
			{
				title: "> KNUST Senior High School (2018-2021)",
				desc: "I graduated from KNUST Senior High School. I was the prefect of my class and here I was able to further my interest in IT and programming.",
			},
		],
	},
	Skills: {
		...
		basics: "Java, C++, VB.net, C#, Python. (For Academics)",
		mobile: "Flutter (Riverpod, GoRouter)",
		web: "React, Next.js (Zustand, Tailwind CSS, Shadcn/UI)",
		backend:
			"PostgreSQL, Prisma, Drizzle, Firebase, Appwrite, Convex, Neon, Clerk",
		tools: "Git/GitHub, Figma, Docker, Penpot, VS Code, Android Studio, Cursor",
		other: "Agile (Scrum), Clean Architecture, REST APIs, UI/UX principles",
	},
};
